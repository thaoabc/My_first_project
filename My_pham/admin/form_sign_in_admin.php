...
<div class="container">
    ...
    <div class="login-item">
      ...
      ?>
      <form action="process_sign_in_admin.php" method="post" class="form form-login">
      ...
      <p class="text--center">Chưa đăng ký?&emsp; <a href="sign_up_admin.php">Tạo tài khoản tại đây</a></p>
    </div>
</div>
